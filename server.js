...
app.get('/smartcar/vehicles/:id/odometer', (req, res) => {
    var tenant = getTenantName(req);
    var accessToken = getToken(req);
    var id = req.params.id
    api.getSmartcarOdometer(tenant, accessToken,id).then(function(result){
        res.send(result);
    }).catch(function(err){
        console.log(err);
        errorResponse(res, err);
...
app.get('/smartcar/user', (req, res) => {
    var tenant = getTenantName(req);
    var accessToken = getToken(req);
    var id = req.params.id;
    api.getSmartcarUser(tenant, accessToken).then(function(result){
        res.send(result);
    }).catch(function(err){
        console.log(err);
        errorResponse(res, err);
